 ...
 * @author Divya
 */
public class SHOW_PROPERTIES_LISTER extends javax.swing.JFrame {

    /**
     * Creates new form SHOW_PROPERTIES_LISTER
     */
    public SHOW_PROPERTIES_LISTER() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1_Verification = new javax.swing.JButton();
        ...
        jButton1_Verification.setBackground(new java.awt.Color(255, 204, 204));
        jButton1_Verification.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jButton1_Verification.setText("PROCEED FOR VERFICATION");
        jButton1_Verification.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1_VerificationActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(77, 77, 77)
                        .addComponent(jButton1_Verification, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(60, 60, 60)))
                .addContainerGap())
        );
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jButton1_Verification, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(61, 61, 61))))
        );
    ...
    private void jButton1_VerificationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_VerificationActionPerformed
        // TODO add your handling code here:
        int selectedRowIndex = jTable1.getSelectedRow();
        int propertyId = Integer.valueOf(jTable1.getValueAt(selectedRowIndex, 0).toString());
        int ownerId = Integer.valueOf(jTable1.getValueAt(selectedRowIndex, 3).toString());
        
        
        P_LISTER type = new P_LISTER(propertyId,ownerId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SHOW_PROPERTIES_LISTER.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SHOW_PROPERTIES_LISTER().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jButton1_Verification;
