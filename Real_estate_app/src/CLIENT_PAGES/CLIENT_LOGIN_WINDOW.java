 ...
 * @author 91992
 */
public class CLIENT_LOGIN_WINDOW extends javax.swing.JFrame {

    /**
     * Creates new form CLIENT_LOGIN_WINDOW
     */
    public CLIENT_LOGIN_WINDOW() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel_Title.setText("CLIENT LOGIN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CLIENT_LOGIN_WINDOW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CLIENT_LOGIN_WINDOW().setVisible(true);
            }
        });
    }
